...
- Music and Comedy open mic modes
- Mobile friendly public signup experience
...
Default music settings are built around a typical weekly open mic:
...
Comedy mode is designed for standup style rooms:

- No song count
- Time based signup only
- Default set length of **5 minutes**
- Tighter wording and guidance for comedy rooms
- Poster wording updates after the event is saved

## Mobile Improvements

Recent updates focused on making the app work better on phones, especially the public signup page.

This includes:

- Better form spacing on mobile
- Cleaner stacking of controls on small screens
- Mobile friendly public lineup display
- Better poster spacing on phones
- Improved small screen behavior overall
...
This app is designed to be simple to host as a static site.
...
3. Choose Music or Comedy mode
4. Save event settings
5. Copy the public link or show the QR code
6. Let performers sign up from their phones
7. Reorder and manage the lineup during the event
8. Export the lineup as CSV if needed

## Suggested Test Flow

- Create a test event
- Test both Music and Comedy modes
...
- Music and Comedy modes
- mobile focused public signup improvements
